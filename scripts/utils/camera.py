...
handle IP CAM, USB webcam or the Jetson onboard camera (MIPI).  In
...
def add_camera_args(parser):
    ...
    parser.add_argument('--onboard', type=int, default=0,
                        help='Jetson onboard camera Port 0 by default')
